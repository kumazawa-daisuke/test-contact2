...
<div class="contact-form__content">
  ...
  <form class="form" action="/confirm" method="post">
    ...
    <div class="form__group">
      ...
      <div class="form__group-content">
        <div class="form__input--radio">
          <input class="form__input-radio-male" type="radio" id="male" name="gender" value="male" checked/>
          <label for="male">男性</label>
          <input class="form__input--radio-female" type="radio" id="female" name="gender" value="female" />
          <label for="female">女性</label>
          <input class="form__input--radio-other" type="radio" id="other" name="gender" value="other" />
    ...
    <div class="form__group">
      ...
      <div class="form__group-content">
        <div class="form__input--text">
          <input class="form__input--email" type="email" name="email" placeholder="test@example.com" value="{{ old('email') }}" />
        </div>
        <div class="form__error">
          @error('email')
          {{ $message }}
